...
public class TestActionsInferred {
    ...
    public void testNoActionsWithEmptyDeclaration() throws Exception {
        String code = "package at.foo.bar.annotations; "
                + "import java.lang.annotation.ElementType; "
                + "import java.lang.annotation.Retention; "
                + "import java.lang.annotation.RetentionPolicy; "
                + "import java.lang.annotation.Target;"
                + " public @interface Exportable { enum Type { A, B;};}";
    ...
    public void testAddMethodCallAndChangeModifiers() throws Exception {
        ...
        MethodCallExpr call =
                (MethodCallExpr) ASTManager.parse(MethodCallExpr.class, "System.out.println(\"hello\");", true);
    ...
    public void testRemoveNonEmptyMethod() throws Exception {
        ...
        String original =
                "public class A { private String name; private void print(){ System.out.println(\"hello\");}}";
        CompilationUnit originalCu = parser.parse(original, false);
    ...
    public void testRemoveBlockStmtWithInnerComments() throws Exception {
        ...
        String original =
                "public class A { private String name;  private void print(){ /*comment*/ System.out.println(\"hello\");}}";
        CompilationUnit originalCu = parser.parse(original, false);
